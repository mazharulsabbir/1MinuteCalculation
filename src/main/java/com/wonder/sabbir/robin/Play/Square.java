...
public class Square extends AppCompatActivity {
    ...
    private static final String SAVE_TO = "Power";
    ...
    int points = 0, totalPoint = 0, value1, value2,quesCase,
            totalQuesNumber = 0, lavel = 0, wrongAnswer = 0, correctanswer = 0, answer, i = 5;
...
//                        Toast.makeText(Square.this, "Error on Add\n" + e.toString(), Toast.LENGTH_SHORT).show();
//
//                    }
//                });
//
//    }
    ...
    public void onBackPressed() {
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(Square.this);
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                saveToSQLite();
                saveToFirebase();
                Intent i = new Intent(Square.this, Gameover.class);
