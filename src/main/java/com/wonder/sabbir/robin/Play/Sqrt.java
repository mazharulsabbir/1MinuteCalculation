...
public class Sqrt extends AppCompatActivity {
    ...
    TextView tv_score, tv_quesview, tv_timeremaining, user;
    int points = 0, totalPoint = 0, value1, value2, quesCase,
            totalQuesNumber = 0, lavel = 0, wrongAnswer = 0, correctanswer = 0, i = 10;
    double answer;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        toolbar_title.setText("Power Root");
        ...
        //user = findViewById(R.id.tv_name);
...
//                        Toast.makeText(Sqrt.this, "Error on Add\n" + e.toString(), Toast.LENGTH_SHORT).show();
//
//                    }
//                });
//
//    }
    ...
    public void setQuesOnTextView() {
        i++;
        formate = new DecimalFormat("#0.00");
        NumberFormat format = new DecimalFormat("#0");
        value1 = Integer.parseInt(format.format(Math.random() * i));
        value2 = Integer.parseInt(format.format(Math.random() * i));
        tv_quesview.setText("√" + "(" + value1 + ")");
        answer = Double.parseDouble(formate.format(Math.sqrt(value1)));
    }
        ...
        try {
            ...
            switch (mb) {
                ...
                case 1: {
                    ...
                    btn1.setText(Double.toString(answer));
                    btn2.setText(formate.format(answer + (Math.random() * 5) + 1));
                    btn3.setText(formate.format(answer + (Math.random() * 5) + 1));
                    btn4.setText(formate.format(answer + (Math.random() * 5) + 1));
                    break;
                }
                case 2: {

                    btn2.setText(Double.toString(answer));
                    btn4.setText(formate.format(answer + (Math.random() * 5) + 1));
                    btn3.setText(formate.format(answer + (Math.random() * 5) + 1));
                    btn1.setText(formate.format(answer + (Math.random() * 5) + 1));
                    break;
                }
                case 3: {

                    btn3.setText(Double.toString(answer));
                    btn2.setText(formate.format(answer + (Math.random() * 5) + 1));
                    btn4.setText(formate.format(answer + (Math.random() * 5) + 1));
                    btn1.setText(formate.format(answer + (Math.random() * 5) + 1));
                    break;
                ...
                case 4: {
                    btn4.setText(Double.toString(answer));
                    btn2.setText(formate.format(answer + (Math.random() * 5) + 1));
                    btn3.setText(formate.format(answer + (Math.random() * 5) + 1));
                    btn1.setText(formate.format(answer + (Math.random() * 5) + 1));
                    break;
    ...
    public void answerButtonOnClick() {
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                totalQuesNumber++;
                if (btn1.getText().equals(Double.toString(answer))) {
                    setQuesOnTextView();
                    setAnswerChoiceOnButton();
                    points += 30;
                    tv_score.setText("Score : " + points);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                totalQuesNumber++;
                if (btn2.getText().equals(Double.toString(answer))) {
                    setQuesOnTextView();
                    setAnswerChoiceOnButton();
                    points += 30;
                    tv_score.setText("Score : " + points);
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                totalQuesNumber++;
                if (btn3.getText().equals(Double.toString(answer))) {
                    setQuesOnTextView();
                    setAnswerChoiceOnButton();
                    points += 30;
                    tv_score.setText("Score : " + points);
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                totalQuesNumber++;
                if (btn4.getText().equals(Double.toString(answer))) {
                    setQuesOnTextView();
                    setAnswerChoiceOnButton();
                    points += 30;
                    tv_score.setText("Score : " + points);
    ...
    public void onBackPressed() {
        ...
        final AlertDialog.Builder b = new AlertDialog.Builder(Sqrt.this);
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                saveToSQLite();
                saveToFirebase();
                Intent i = new Intent(Sqrt.this, Gameover.class);
