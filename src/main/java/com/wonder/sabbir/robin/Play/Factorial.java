...
public class Factorial extends AppCompatActivity {
    ...
    int points = 0, totalPoint = 0, quesCase,value1, value2, lavel = 0, btn_testcase, totalQuesNumber = 0, wrongAnswer = 0, answer, i = 5;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        toolbar_title.setText("Factorial");
    ...
    public void onBackPressed() {
        ...
        final AlertDialog.Builder b = new AlertDialog.Builder(Factorial.this);
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                mTimerRunning = false;
                saveToSQLite();
                Intent i = new Intent(Factorial.this, Gameover.class);
