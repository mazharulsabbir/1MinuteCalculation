...
public class Rand extends AppCompatActivity {
    ...
    private static final String TAG = "Rand";
    private static final String COLLECTION = "Rand";
    private static final String SAVE_TO = "Random";
    ...
    int points = 0, temp, totalPoint = 0, lavel = 0, value1, value2,
            totalQuesNumber = 0, correctanswer = 0, wrongAnswer = 0, quesCase, answer, i = 10;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        //ACTIONBAR NAME AND STYLE START:

        TextView toolbar_title = findViewById(R.id.toolbar_title);
        toolbar_title.setText("Random");
        //ACTIONBAR NAME AND STYLE END:
...
//                        Toast.makeText(Rand.this, "Error on Add\n" + e.toString(), Toast.LENGTH_SHORT).show();
//
//                    }
//                });
//
//    }
    ...
    public void setQuesOnTextView() {
        ...
        int value4 = Integer.parseInt(format.format(Math.random() * i));

        double tc = (Math.random() * quesCase) + 1;
        int mb = (int) tc;
        ...
        switch (mb) {
            ...
            case 4:
                tv_quesview.setText(value1 + "+" + value2 + "+" + value3);
                answer = value1 + value2 + value3;
                break;

            case 5:
                tv_quesview.setText("(" + value1 + "-" + value2 + ")+(" + value3 + "-" + value4 + ")");
            ...
            case 10:
                value1 = Integer.parseInt(format.format(Math.random() * 10));
                value2 = Integer.parseInt(format.format(Math.random() * 5));
                tv_quesview.setText(Html.fromHtml(Integer.toString(value1) + "<sup>" + Integer.toString(value2) + "</sup>"));
                answer = (int) Math.pow(value1, value2);
                break;

            case 11:
                value1 = Integer.parseInt(format.format(Math.random() * 10));
                value2 = Integer.parseInt(format.format(Math.random() * 30));
    ...
    public void onBackPressed() {
        final AlertDialog.Builder b = new AlertDialog.Builder(Rand.this);
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                saveToSQLite();
                saveToFirebase();
                Intent i = new Intent(Rand.this, Gameover.class);
