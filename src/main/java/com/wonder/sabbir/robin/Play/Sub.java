...
public class Sub extends AppCompatActivity {
    ...
    private static final String SAVE_TO = "Subtraction";
    ...
    int points = 0, totalPoint = 0, lavel = 0, value1, value2, totalQuesNumber = 0,
            correctanswer = 0, answer, wrongAnswer = 0, i = 10, quesCase;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        toolbar_title.setText("Subtraction");
        //jhdsfjdshfsdhg
...
//                            totalpoints = Integer.parseInt(totalScore);
//                        }
//
//                    }
//                })
...
//                        Toast.makeText(Sub.this, "Error on Subtraction\n" + e.toString(), Toast.LENGTH_SHORT).show();
//
//                    }
//                });
//
//    }
    ...
    public void onBackPressed() {
        ...
        final AlertDialog.Builder b = new AlertDialog.Builder(Sub.this);
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                saveToSQLite();
                saveToFirebase();
                Intent i = new Intent(Sub.this, Gameover.class);
