...
public class Add extends AppCompatActivity {
    ...
    private static final String SAVE_TO = "Addition";
    ...
    String mPlayerName, mPlayerEmail, getLavel = "1";
    String checkLavel = "";
    ...
    int points = 0, totalPoint = 0, value1, value2, totalQuesNumber = 0,
            correctanswer = 0, wrongAnswer = 0, answer, i = 10, lavel = 1,
            quesCase = 1;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        toolbar_title.setText("Addition");
...
//        mAdView.loadAd(adRequest);
        ...
        getLavel = intent.getStringExtra(LAVEL);
        ...
        lavel = Integer.parseInt(getLavel);
        swithchLavel(lavel);
    ...
    public void onBackPressed() {
        final AlertDialog.Builder mDialog = new AlertDialog.Builder(Add.this);
        View mView = getLayoutInflater().inflate(R.layout.activity_on_back, null);
        mDialog.setView(mView);
        final AlertDialog dialog = mDialog.create();
        mDialog.setCancelable(false);
        dialog.setCancelable(false);
        dialog.show();
        Button btn_Continue = mView.findViewById(R.id.button_Continue);
        Button btn_back_Home = mView.findViewById(R.id.button_Back_Home);
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                mTimerRunning = false;
                saveToSQLite();
                Intent i = new Intent(Add.this, Gameover.class);
                ...
                i.putExtra(PLAYER, mPlayerName);
                i.putExtra(PLAYER_EMAIL, mPlayerEmail);
                startActivity(i);
                finish();
            }
        }.start();
